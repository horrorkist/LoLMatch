...
import { getSummonerInfoBySummonerName } from "../../lib/server/api/riot";
...
const champion = {
  ...
  data: {
    ...
    DrMundo: {
      ...
      blurb:
        "Utterly mad, tragically homicidal, and horrifyingly purple, Dr. Mundo is what keeps many of Zaun's citizens indoors on particularly dark nights. Now a self-proclaimed physician, he was once a patient of Zaun's most infamous asylum. After the...",
      info: {
        attack: 5,
        defense: 7,
        magic: 6,
